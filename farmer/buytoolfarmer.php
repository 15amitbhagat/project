...
$sql = mysqli_query($conn,"SELECT product_name,product_description,product_quantity,product_price,image,category from addtool");
?>
...
<body>
    ...
    <div class="container mt-4">
        <div class="jumbotron">
  <h1 class="display-4">Buy Tools</h1>
  <p class="lead"></p>
  <div class="row">
  ...
  <a href="project/farmer/payments.php?fid=<?php echo $row['fid']?>" class="card-link">Buy</a>
  </div>
</div>
    </div>
  <?php } ?>
