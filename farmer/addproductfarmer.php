...
<?php 
    ...
    if(isset($_POST['submit'])){
        ...
        $insert = mysqli_query($conn,"INSERT INTO addfarmer(id,product_name,product_description,product_quantity,product_price,category,image) 
...
<body>
      ...
      <nav>
        ...
        <?php if($_SESSION['user'] =='farmer') { ?>
            ...
            <li><a href="project/farmer/viewproductfarmer.php">View Product</a></li>
