...
<?php 
    ...
    $fid = $_GET['fid'];
    $row = mysqli_fetch_assoc(mysqli_query($conn,"SELECT * from addtool where fid ='$fid' "));
    echo($row);
    ...
    if(isset($_POST['submit'])){
        ...
        $insert = mysqli_query($conn,"UPDATE addtool SET product_name = '$product_name' where fid ='$fid' ");
        if($insert ){
